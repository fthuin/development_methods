...
\begin{document}
    ...
    \noindent
    \begin{tikzpicture}
        \umlclass[x=4]{Purchase}{amount \\ price}{}
        \umlsimpleclass[y=-3]{Cash Purchase}
        \umlsimpleclass[x=4,y=-3]{Account Purchase}
        \umlsimpleclass[x=8,y=-3]{Credit purchase}
        \umlsimpleclass[x=8]{Fuel}
        \umlsimpleclass[x=8, y=-1]{Gas pump}
        \umlclass[x=12]{Fuel Stock}{amount}{}
        \umlclass[x=4,y=-6]{Payment}{price}{}
        \umlsimpleclass[x=2,y=-9]{Check payment}
        \umlsimpleclass[x=6,y=-9]{Credit payment}
        \umlclass[x=13, y=-3]{Credit transaction}{cardNumber \\ price}{}
        \umlclass[x=13, y=-8]{Account}{number \\ balance}{}
        \umlsimpleclass[x=13, y=-12]{Customer}

        \umlinherit{Cash Purchase}{Purchase}
        \umlinherit{Account Purchase}{Purchase}
        \umlinherit{Credit purchase}{Purchase}
        \umlassoc[mult1=1, mult2=*]{Fuel}{Purchase}
        \umlassoc[mult1=1, mult2=*]{Gas pump}{Purchase}
        \umlassoc[mult1=1, mult2=1]{Fuel Stock}{Fuel}
        \umlassoc[mult1=1, mult2=0..1]{Credit transaction}{Credit purchase}
        \umlassoc[mult1=1, mult2=*]{Account}{Account Purchase}
        \umlassoc[mult1=1, align1=left, mult2=0..1, align2=right]{Credit transaction}{Credit payment}
        \umlassoc[mult1=*, mult2=1]{Payment}{Account}
        \umlassoc[mult1=1, mult2=0..1]{Customer}{Account}
    ...
    \begin{tikzpicture}[on grid, auto]
        ...
        \umlclass[y=-6]{Account}{+number: String\\ +balance:float}{}
        ...
        \umlclass[x=3,y=-6]{Payment}{+price: float\\ +date: Date}{}
        \umlsimpleclass[x=1,y=-9]{Check payment}
        \umlsimpleclass[x=4.5,y=-9]{Credit payment}
        ...
        \umlassoc{Purchase}{Fuel}
        \umlassoc{Fuel}{Fuel stock}
        ...
        \umlassoc[geometry=|-|, anchor1=220, anchor2=-135]{Account}{Customer}
        \umlassoc[geometry=|-|]{Account}{Account purchase}
        \umlassoc{Credit transaction}{Credit payment}
        \umlassoc{Cashier}{Cashier's interface}
        \umlassoc{Controller}{Cashier's interface}
        \umlassoc{Controller}{Credit card system}
        \umlassoc{Controller}{Gas pump controller}
        \umlassoc{Gas pump controller}{Credit card reader}
        \umlassoc{Gas pump controller}{Gas pump interface}
        \umlassoc{Gas pump controller}{Gas pump}
        \umlassoc{Gas pump}{Purchase}
    \end{tikzpicture}
    \restoregeometry
