...
\begin{document}
    ...
    \begin{tikzpicture}
        \umlclass[type=interface,x=5]{Reporting}{}{\textit{+print(): void}}
        \umlclass[x=2,y=-3]{Payment}{+price: float\\ +date: Date}{+print(): void}
        \umlclass[x=8,y=-3]{Account}{+number: String\\ +balance: float}{+print(): void}
        \umlsimpleclass[y=-5.5]{Check payment}
        \umlsimpleclass[x=4,y=-5.5]{Credit payment}
        ...
        \umlnote[x=10]{Reporting}{public void print();}
        \umlnote[x=12,y=-9, width=8cm]{Account}{public class Account implements Reporting \{ \\
                                     ...
                                     \ \ \ \ ... \\
                                     \}}
        \umlnote[x=2,y=-9, width=8cm]{Payment}{public class Account implements Reporting \{ \\
